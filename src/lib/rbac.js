...
export const ROLE_PERMISSIONS = {
  ...
  owner: [
    ...
    'attendance.view','payroll.view','payroll.approve','payroll.print',
    'loans.view','loans.approve.final',
    'leave.view','leave.approve',
    'shifts.view','documents.view',
  ...
  hr: [
    ...
    'attendance.view','attendance.edit','attendance.approve','attendance.import',
  ...
  employee: [
    'dashboard.view','my.requests','requests.create','leave.create','attendance.view',
  ],
};
